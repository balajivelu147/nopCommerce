...
namespace Nop.Data.Mapping
{
    ...
    public partial class BaseNameCompatibility : INameCompatibility
    {
        public Dictionary<Type, string> TableNames => new()
        {
            ...
            { typeof(DiscountVendorMapping), "Discount_AppliedToVendors" },
        ...
        public Dictionary<(Type, string), string> ColumnName => new()
        {
            ...
            { (typeof(DiscountVendorMapping), "DiscountId"), "Discount_Id" },
            { (typeof(DiscountVendorMapping), "EntityId"), "Vendor_Id" },
