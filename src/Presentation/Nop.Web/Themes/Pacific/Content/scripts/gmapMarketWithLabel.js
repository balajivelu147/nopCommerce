...
MarkerClusterer.prototype.calculator_ = function (markers, numStyles) {
  ...
  return {
    text: count + ' something<br/>A. Rs' + price,
    index: index
  };
};
...
function initialize() {
 ...
 // var matchingProductsForMap = JSON.parse(document.getElementById("matchingProductsForMap")?.value);
  ...
  createGroup(markersArr)
}
function init3() {

}
//google.maps.event.addDomListener(window, 'load', initialize);
//   setTimeout(google.maps.event.addDomListener(window, 'load', initialize)
//     , 5000);

function init2() {
  loadScript('https://unpkg.com/@googlemaps/markerwithlabel/dist/index.min.js',
    function () {
      setTimeout(google.maps.event.addDomListener(window, 'load', initialize)
        , 10000);
       /* google.maps.event.addDomListener(window, 'load', initialize)*/;
...
//loadScript('https://maps.googleapis.com/maps/api/js?&sensor=false&v=3&key=AIzaSyCNQrOZMXYBcGlvkXMBGeD68FQxpaQhGdw&callback=init3',
//  function () {  });
